...
const carouselItems = [
  {
    ...
    descriptionItems: [
      ...
      { icon: <FiCheckCircle className="mr-2 text-green-600" />, text: '+11 mil gamers satisfeitos' },
    ],
  ...
  },
  {
    ...
    descriptionItems: [
      ...
      { icon: <FiCheckCircle className="mr-2 text-green-600" />, text: '+9 mil escritórios atendidos na região' },
    ],
